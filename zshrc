...
alias idea="~/idea-IU-232.8660.185/bin/idea.sh &"
alias tmux="tmux -f ~/.config/tmux/.tmux.conf"
alias lza="lazydocker -f ~/Documentos/master/docker-compose.yml"
alias tx="tmuxinator"
...
# __conda_setup="$('/home/ask-028/anaconda3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
# if [ $? -eq 0 ]; then
#     eval "$__conda_setup"
# else
#     if [ -f "/home/ask-028/anaconda3/etc/profile.d/conda.sh" ]; then
#         . "/home/ask-028/anaconda3/etc/profile.d/conda.sh"
#     else
#         export PATH="/home/ask-028/anaconda3/bin:$PATH"
#     fi
# fi
# unset __conda_setup
# <<< conda initialize <<<
